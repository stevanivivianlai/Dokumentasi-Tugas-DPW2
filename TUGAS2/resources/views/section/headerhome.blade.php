                    ...
                    <div class="col-lg-3">
                        <div class="all-category">
                            ...
                            <ul class="main-category">
                                <li><a href="#">Barang Terbaru <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                ...
                                <li class="main-mega"><a href="#">best selling <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                    <ul class="mega-menu">
                                        <li class="single-menu">
                                            <a href="#" class="title-link">Mainan anak-anak</a>
                                            <div class="image">
                                                <img src="{{asset('style/images/mainan.png')}}" alt="#">
                                            </div>
                                        ...
                                        <li class="single-menu">
                                            <a href="#" class="title-link">Produk Pria</a>
                                            <div class="image">
                                                <img src="{{asset('style/images/perempuan.png')}}" alt="#">
                                            </div>
                                            <div class="inner-link">
                                        ...
                                        <li class="single-menu">
                                            <a href="#" class="title-link">Produk perempuan</a>
                                            <div class="image">
                                                <img src="{{asset('style/images/lakilaki.png')}}" alt="#">
                                            </div>
                                            <div class="inner-link">
