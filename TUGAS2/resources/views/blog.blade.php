					...
					<div class="col-lg-8 col-12">
						<div class="blog-single-main">
							<div class="row">
								<div class="col-12">
									<div class="image">
										<img src="{{asset('style/images/bali1.png')}}" alt="#">
									</div>
									<div class="blog-detail">
										<h2 class="blog-title">Tempat Wisata yang menarik di Bali!</h2>
										<div class="blog-meta">
											<span class="author"><a href="#"><i class="fa fa-user"></i>By Admin</a><a href="#"><i class="fa fa-calendar"></i>Dec 24, 2020</a><a href="#"><i class="fa fa-comments"></i>Comment (15)</a></span>
										</div>
										<div class="content">
											<p>Siapa tak kenal Bali, pulau yang terkenal dengan keindahan pantainya ini merupakan top destinasi terbaik dunia. Bahkan, Bali menduduki peringkat pertama dari 25 destinasi terbaik dunia mengalahkan destinasi di Eropa, Amerika hingga Timur Tengah

                                            
                                            
                                           </p>
											<blockquote> <i class="fa fa-quote-left"></i> Menurut situs TriAdvisor, pulau Bali di Indonesia merupakan destinasi favorit, baik untuk wisatawan yang butuh rileksasi sekaligus petualangan. Bagi traveler yang mendambakan budaya, petualangan atau keindahan pantai, Bali jawabannya.</blockquote>
											<p>Selain menikmati keindahan alam, Anda juga bisa melihat budaya khas Bali yaitu pertunjukan Tari Kecak. Salah satu tarian yang menarik adalah Tari Kecak Uluwatu yang berada di Pura Uluwatu. Tari Kecak Uluwatu mempertunjukan tari kecak khas Bali dengan latar belakang matahari tenggelam di Uluwatu yang sangat indah. Tari Kecak Uluwatu sangat populer dan ramai.
s</p>
										</div>
									</div>
				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							...
							<p class="text">kami adalah toko terbaik dari yang terbaik dibidang fashion.</p>
							<p class="call">Ada pertanyaan? hubungi kami 24/7<span><a href="tel:123456789">+628 96868662</a></span></p>
						</div>
						<!-- End Single Widget -->
					</div>
					...
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-footer social">
							...
							<div class="contact">
								<ul>
									<li>NO. 342 - Jln may jend sutoyo.</li>
									<li>Ketapang, Kalimantan barat.</li>
									<li>info@vivishop.com</li>
									<li>+628 3456 7890</li>
								</ul>
							</div>
							<!-- End Single Widget -->
				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>Copyright © 2020 <a href="http://www.vivishop.com" target="_blank">Vivishop</a>  -  All Rights Reserved.</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
